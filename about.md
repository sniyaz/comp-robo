...
**Note 1:** This means that points in different categories (Lab, Midterm, Final) are worth different percentages of your final grade: your percentage in each category gets reweighted according to the "recipe" above.
...
- You should never directly show another student your code or your write-up PDF. This means you should never send your files to another student nor should you screen share your work for other students.
...
Since AI tools are common now, here is a clear policy on what is and is not allowed in this course.
